...
namespace DevCode.Extensions.Tests.DateTiming
{
    public class DayOfWeekExtensions_Tests
    {
        ...
        public void Weekend_Weekday_Test()
        {
            ...
            datetime1.DayOfWeek.IsWeekend(false).ShouldBe(true);
            datetime2.DayOfWeek.IsWeekend(false).ShouldBe(false);

            datetime1.DayOfWeek.IsWeekday(false).ShouldBe(false);
            datetime2.DayOfWeek.IsWeekday(false).ShouldBe(true);
        }
